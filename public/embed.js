  ...
  class ProofPopifyWidget {
    ...
    applyStyles() {
      ...
      if (this.isTest || this.isDummy) {
        ...
        const stripeSvg = `<svg viewBox="0 0 60 25" style="height: 12px; margin-left: 2px; margin-top: 1px;" fill="#635BFF"><path d="M59.64 14.28h-8.06c.19 1.93 1.6 2.55 3.2 2.55 1.64 0 2.96-.37 4.05-.95v3.32a8.33 8.33 0 0 1-4.56 1.1c-4.01 0-6.83-2.5-6.83-7.48 0-4.19 2.39-7.52 6.3-7.52 3.92 0 5.96 3.28 5.96 7.5 0 .4-.04 1.26-.06 1.48zm-5.92-5.62c-1.03 0-2.17.73-2.17 2.58h4.25c0-1.85-1.07-2.58-2.08-2.58zM43.7 20.3c-1.9 0-3.18-.91-3.18-2.92V9.92h-2.1V6.15h2.1V2.62h4.08v3.52h3.04v3.78h-3.04v6.86c0 .86.43 1.15 1.25 1.15.54 0 1.05-.1 1.74-.45v3.7c-.89.36-2.11.58-3.89.58zM31.25 1.04h4.08v19.1h-4.08V1.04zm-8.23 8.89c-.66-.63-1.63-.98-2.59-.98-2.09 0-3.3 1.34-3.3 3.65 0 2.29 1.25 3.63 3.32 3.63.95 0 1.92-.34 2.57-.96v-5.34zm0-3.76v-1.1c-.88-.5-2.03-.76-3.16-.76-3.9 0-7.39 2.4-7.39 7.42 0 4.3 2.65 7.45 6.94 7.45 1.46 0 2.72-.37 3.61-.9v3.08h4.08V6.17h-4.08zM15.11 9.93c-.66-.63-1.63-.98-2.59-.98-2.09 0-3.3 1.34-3.3 3.65 0 2.29 1.25 3.63 3.32 3.63.95 0 1.92-.34 2.57-.96v-5.34zm0-3.76v-1.1c-.88-.5-2.03-.76-3.16-.76-3.9 0-7.39 2.4-7.39 7.42 0 4.3 2.65 7.45 6.94 7.45 1.46 0 2.73-.37 3.61-.9v6.52c0 2.95-1.9 4.34-4.8 4.34-1.6 0-3.23-.39-4.89-1.28v-3.88c1.37.74 3.01 1.11 4.56 1.11 1.08 0 1.84-.36 1.84-1.34V15.7c-.88.54-2.15.91-3.61.91-4.29 0-6.94-3.15-6.94-7.45 0-5.02 3.48-7.42 7.39-7.42 1.13 0 2.28.26 3.16.76V6.17h-4.08zM4.91 16.77c-1.33 0-2.33-.28-3.41-.75v-3.79c1.07.61 2.43 1.03 3.65 1.03 1.2 0 1.79-.31 1.79-.88 0-.58-.69-.8-1.91-1.13-1.78-.47-3.46-1.1-3.46-3.05 0-1.87 1.6-3.46 4.3-3.46 1.3 0 2.68.3 3.65.75v3.66c-.95-.53-2.17-.9-3.38-.9-1.07 0-1.61.35-1.61.85 0 .54.67.75 1.87 1.07 1.96.53 3.51 1.18 3.51 3.1 0 1.92-1.57 3.5-4.4 3.5z"/></svg>`;
        verifyText.innerHTML = `<span style="opacity: 0.6">Verified by</span> ${stripeSvg}`;
      }
